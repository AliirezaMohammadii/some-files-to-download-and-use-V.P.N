...
Well, I've put all the download URLs in "downloadـlinksـtoـsend" text file, and you can send it to your friends (via email, or ...), and they can use it to download any of chrome vpn extension files. (You can't send the files via email directly, because Google Security checks the content of files while uploading in attachment and blocks uploading process!)
